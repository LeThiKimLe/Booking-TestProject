...
async function testLoginSucessAdmin(driver, username, password) {
    try {
...
async function testLoginSucessStaff(driver, username, password) {
    try {
        // Navigate to the login page
        await driver.get('http://localhost:3001/login');
...
async function testLoginNotAuthorAccount(driver) {
    try {
        ...
        // Enter the username and password
        await usernameInput.sendKeys('thanh@gmail.com');
...
describe('Login Test Staff', function() {
    ...
    it('Đăng nhập thành công tài khoản admin', async () => await testLoginSucessAdmin(driver, 'nnguyen@gmail.com', '1234567'));
    
    it('Đăng nhập thành công tài khoản nhân viên', async () => await testLoginSucessStaff(driver, 'thom@gmail.com', '123456'));
